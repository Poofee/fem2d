...
public:
	...
	static int lua_elements(lua_State *L);
	static int lua_nodes(lua_State *L);
	static int lua_lbls(lua_State *L);
	static int lua_blks(lua_State *L);
	static int lua_getelement(lua_State *L);
	static int lua_getnode(lua_State *L);
	static int lua_getlbl(lua_State *L);
	static int lua_getblk(lua_State *L);
