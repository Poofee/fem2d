...
class fe_CLibDlg : public CResizableDialog
{
// Construction
public:
	fe_CLibDlg(CWnd* pParent = NULL);	// standard constructor
	...
	void CopyBHdata(CMaterialProp &source, CMaterialProp &dest);
